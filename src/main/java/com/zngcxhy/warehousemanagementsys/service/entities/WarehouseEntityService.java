...
import com.zngcxhy.warehousemanagementsys.repository.entities.WarehouseEntityMapper;
...
public class WarehouseEntityService extends AbstractService {
    ...
    public WarehouseEntityService() {
        ...
        entityFieldNameTitleMap.put("warehouseName", "仓库名");
        entityFieldTitleNameMap.put("仓库名", "warehouseName");
        entityFiledColumnNameMap.put("warehouseName", "warehouse_name");
    }
    ...
    **/
    ...
    public WarehouseEntity create(WarehouseEntity entity) {
        ...
        entity.setWarehouseName(getOrDefault(entity.getWarehouseName(), ""));
