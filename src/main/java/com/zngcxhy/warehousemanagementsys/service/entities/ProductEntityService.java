...
import com.zngcxhy.warehousemanagementsys.repository.entities.ProductEntityMapper;
...
/**
* auto generate ProductEntity ServiceImpl
*
* @author sys
*/
@Service
public class ProductEntityService extends AbstractService {
    @Resource
    ...
    public ProductEntityService() {
        entityFieldNameTitleMap.put("id", "产品编号");
        entityFieldTitleNameMap.put("产品编号", "id");
        ...
        entityFiledColumnNameMap.put("productName", "product_name");
        entityFieldNameTitleMap.put("description", "产品规格");
        entityFieldTitleNameMap.put("产品规格", "description");
        entityFiledColumnNameMap.put("description", "description");
        entityFieldNameTitleMap.put("supillerId", "供应商ID");
        entityFieldTitleNameMap.put("供应商ID", "supillerId");
        entityFiledColumnNameMap.put("supillerId", "supiller_id");
        ...
        entityFieldNameTitleMap.put("supplierName", "供应商名称");
        entityFieldTitleNameMap.put("供应商名称", "supplierName");
        entityFiledColumnNameMap.put("supplierName", "supplier_name");
        entityFieldNameTitleMap.put("product_potot", "产品图片");
        entityFieldTitleNameMap.put("产品图片", "product_potot");
        entityFiledColumnNameMap.put("product_potot", "product_potot");
        entityFieldNameTitleMap.put("unit1", "产品单价");
        entityFieldTitleNameMap.put("产品单价", "unit1");
        entityFiledColumnNameMap.put("unit1", "unit1");
    }
    ...
    **/
    ...
    public ProductEntity create(ProductEntity entity) {
        ...
        entity.setSupillerId(getOrDefault(entity.getSupillerId(), 0L));
        entity.setStockQuantity(getOrDefault(entity.getStockQuantity(), 0L));
        entity.setSupplierName(getOrDefault(entity.getSupplierName(), ""));
        entity.setProduct_potot(getOrDefault(entity.getProduct_potot(), ""));
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<ProductEntity> batchCreate(List<ProductEntity> entities) {
    ...
    **/
    @Transactional
    public ProductEntity update(ProductEntity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "ProductEntity");
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<ProductEntity> batchUpdate(List<ProductEntity> entities, List<String> updateFields) {
        if (null == entities || entities.isEmpty()) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_NOTHING_TODO.code);
        }
        // updateFields为null时，默认全量更新
        List<ProductEntity> updateEntities = new ArrayList<>(entities.size());
        for (ProductEntity entity : entities) {
    ...
    **/
    ...
    public long delete( Long id ) { 
        ...
        ProductEntity entity = mapper.selectOne( id ); 
    ...
    **/
    public List<ProductEntity> list(AbstractQueryFilter queryFilter) {
        if (null == queryFilter) {
    ...
    **/
    ...
    public String importFile(MultipartFile file) {
        ...
        try {
            List<ProductEntity> data = ExcelUtil.read(file.getInputStream(), type, ProductEntity.class, entityFieldTitleNameMap);
            batchCreate(data);
            return "ok";
        } catch (Exception e) {
    ...
    **/
    public ResponseEntity<org.springframework.core.io.Resource> export(AbstractQueryFilter queryFilter, String fields, HttpServletRequest request) {
        try {
            ...
            List<ProductEntity> data = list(queryFilter);
            String storeFilePath = ExcelUtil.write(data, ProductEntity.class, exportFieldMap);
            ...
            return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + ProductEntity.class.getSimpleName() + ".xlsx\"")
                .body(resource);
        } catch (Exception e) {
            throw new HttpCodeException(500, e);
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public ProductEntity createOrUpdate(ProductEntity entity, List<String> updateFields) {
        if (null == entity) {
        ...
        if ( entity.getId() == null ) { 
            ...
            ProductEntity existEntity = mapper.selectOne(entity.getId()); 
            if (null == existEntity) {
                // insert
                entity.setCreatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
                entity.setUpdatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public long updateBy(ProductEntity entity, List<String> updateFields, AbstractQueryFilter filter) {
