...
import com.zngcxhy.warehousemanagementsys.domain.entities.LCAPResource;
import com.zngcxhy.warehousemanagementsys.domain.enumeration.*;
import com.zngcxhy.warehousemanagementsys.domain.structure.*;
import com.zngcxhy.warehousemanagementsys.datasource.dynamic.DataSource;
import com.zngcxhy.warehousemanagementsys.repository.entities.LCAPResourceMapper;
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("LCAPResource", "lcap_resource_6568a7", "id", "id"))
