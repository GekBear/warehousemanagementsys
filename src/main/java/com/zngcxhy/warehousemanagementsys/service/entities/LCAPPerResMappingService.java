...
import com.zngcxhy.warehousemanagementsys.repository.entities.LCAPPerResMappingMapper;
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("LCAPPerResMapping", "lcap_per_res_mapping_6568a7", "id", "id"))
