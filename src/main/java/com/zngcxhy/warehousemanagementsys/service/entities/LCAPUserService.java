...
import com.zngcxhy.warehousemanagementsys.repository.entities.LCAPUserMapper;
...
public class LCAPUserService extends AbstractService {
    ...
    public LCAPUserService() {
        ...
        entityFieldNameTitleMap.put("roleId", "角色ID");
        entityFieldTitleNameMap.put("角色ID", "roleId");
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("LCAPUser", "lcap_user_6568a7", "id", "id"))
