...
import com.zngcxhy.warehousemanagementsys.repository.entities.LCAPRolePerMappingMapper;
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("LCAPRolePerMapping", "lcap_role_per_mapping_6568a7", "id", "id"))
