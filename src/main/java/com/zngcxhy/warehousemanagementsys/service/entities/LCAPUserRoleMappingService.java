...
import com.zngcxhy.warehousemanagementsys.repository.entities.LCAPUserRoleMappingMapper;
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("LCAPUserRoleMapping", "lcap_user_role_mapping_6568a7", "id", "id"))
