...
import com.zngcxhy.warehousemanagementsys.repository.entities.Delivery_orderEntityMapper;
...
/**
* auto generate Delivery_orderEntity ServiceImpl
*
* @author sys
*/
@Service
public class Delivery_orderEntityService extends AbstractService {
    @Resource
    private Delivery_orderEntityMapper mapper;
    @Resource
    ...
    public Delivery_orderEntityService() {
    ...
    **/
    ...
    public Delivery_orderEntity create(Delivery_orderEntity entity) {
        if (null == entity) {
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<Delivery_orderEntity> batchCreate(List<Delivery_orderEntity> entities) {
        ...
        // fill default value
        for (Delivery_orderEntity entity : entities) {
            entity.setId(SnowflakeIdWorker.getInstance().nextId());
            entity.setCreatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
            entity.setUpdatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
            entity.setCreatedBy(StringUtils.isBlank(entity.getCreatedBy()) ? currentUserName : entity.getCreatedBy());
    ...
    **/
    @Transactional
    public Delivery_orderEntity update(Delivery_orderEntity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, "Delivery_orderEntity");
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public List<Delivery_orderEntity> batchUpdate(List<Delivery_orderEntity> entities, List<String> updateFields) {
        if (null == entities || entities.isEmpty()) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_NOTHING_TODO.code);
        }
        // updateFields为null时，默认全量更新
        List<Delivery_orderEntity> updateEntities = new ArrayList<>(entities.size());
        for (Delivery_orderEntity entity : entities) {
    ...
    **/
    ...
    public long delete( Long id ) { 
        ...
        Delivery_orderEntity entity = mapper.selectOne( id ); 
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("Delivery_order", "delivery_order", "id", "id"))
            .right(new ListLiteralQueryFilter(ids));
        CommonFunctionUtil.preHandleQueryExpression(inQueryFilter, entityFiledColumnNameMap);
        List<Delivery_orderEntity>  entities = mapper.selectList(inQueryFilter);
        for (Delivery_orderEntity entity : entities) {
            relationInnerService.onDelete(entity);
        }
     ...
     * auto gen get method
     **/
    public Delivery_orderEntity get( Long id ) { 
        if ( id == null ) { 
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_PRIMARY_KEY_REQUIRED.code);
        }
    ...
    **/
    public List<Delivery_orderEntity> list(AbstractQueryFilter queryFilter) {
        if (null == queryFilter) {
    ...
    **/
    ...
    public String importFile(MultipartFile file) {
        ...
        try {
            List<Delivery_orderEntity> data = ExcelUtil.read(file.getInputStream(), type, Delivery_orderEntity.class, entityFieldTitleNameMap);
            batchCreate(data);
            return "ok";
        } catch (Exception e) {
    ...
    **/
    public ResponseEntity<org.springframework.core.io.Resource> export(AbstractQueryFilter queryFilter, String fields, HttpServletRequest request) {
        try {
            ...
            List<Delivery_orderEntity> data = list(queryFilter);
            String storeFilePath = ExcelUtil.write(data, Delivery_orderEntity.class, exportFieldMap);
            ...
            return ResponseEntity.ok()
                ...
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + Delivery_orderEntity.class.getSimpleName() + ".xlsx\"")
                .body(resource);
        } catch (Exception e) {
            throw new HttpCodeException(500, e);
        }
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public Delivery_orderEntity createOrUpdate(Delivery_orderEntity entity, List<String> updateFields) {
        if (null == entity) {
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_REQUIRED.code, Delivery_orderEntity.class);
        }
        ...
        if ( entity.getId() == null ) { 
            ...
            Delivery_orderEntity existEntity = mapper.selectOne(entity.getId()); 
            if (null == existEntity) {
                // insert
                entity.setCreatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
                entity.setUpdatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
    ...
    **/
    @Transactional(rollbackFor = Exception.class)
    public long updateBy(Delivery_orderEntity entity, List<String> updateFields, AbstractQueryFilter filter) {
