...
import com.zngcxhy.warehousemanagementsys.repository.entities.ShelfEntityMapper;
...
public class ShelfEntityService extends AbstractService {
    ...
    public ShelfEntityService() {
        ...
        entityFieldNameTitleMap.put("shelfName", "货架名");
        entityFieldTitleNameMap.put("货架名", "shelfName");
        entityFiledColumnNameMap.put("shelfName", "shelf_name");
        entityFieldTitleNameMap.put("wareId", "wareId");
        entityFiledColumnNameMap.put("wareId", "ware_id");
    }
    ...
    **/
    ...
    public ShelfEntity create(ShelfEntity entity) {
        ...
        entity.setShelfName(getOrDefault(entity.getShelfName(), ""));
