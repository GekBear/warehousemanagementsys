...
import com.zngcxhy.warehousemanagementsys.repository.entities.LCAPPermissionMapper;
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("LCAPPermission", "lcap_permission_6568a7", "id", "id"))
