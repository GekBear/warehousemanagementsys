...
import com.zngcxhy.warehousemanagementsys.repository.entities.PurchaseOrderEntityMapper;
...
/**
* auto generate PurchaseOrderEntity ServiceImpl
*
* @author sys
*/
@Service
public class PurchaseOrderEntityService extends AbstractService {
    ...
    public PurchaseOrderEntityService() {
        ...
        entityFieldNameTitleMap.put("expectedDeliveryDate", "预计交货日期");
        entityFieldTitleNameMap.put("预计交货日期", "expectedDeliveryDate");
        entityFiledColumnNameMap.put("expectedDeliveryDate", "expected_delivery_date");
        ...
        entityFieldNameTitleMap.put("manager", "经理意见");
        entityFieldTitleNameMap.put("经理意见", "manager");
        entityFiledColumnNameMap.put("manager", "manager");
        entityFieldNameTitleMap.put("supplier", "供应商意见");
        entityFieldTitleNameMap.put("供应商意见", "supplier");
        entityFiledColumnNameMap.put("supplier", "supplier");
        entityFieldNameTitleMap.put("no", "驳回原因");
        entityFieldTitleNameMap.put("驳回原因", "no");
        entityFiledColumnNameMap.put("no", "no");
        entityFieldNameTitleMap.put("supplierno", "供应商驳回原因");
        entityFieldTitleNameMap.put("供应商驳回原因", "supplierno");
        entityFiledColumnNameMap.put("supplierno", "supplierno");
        entityFieldNameTitleMap.put("after", "有无售后");
        entityFieldTitleNameMap.put("有无售后", "after");
        entityFiledColumnNameMap.put("after", "after");
        entityFieldNameTitleMap.put("delivery_order", "收货地址");
        entityFieldTitleNameMap.put("收货地址", "delivery_order");
        entityFiledColumnNameMap.put("delivery_order", "delivery_order");
        entityFieldNameTitleMap.put("documents", "发票生成");
        entityFieldTitleNameMap.put("发票生成", "documents");
        entityFiledColumnNameMap.put("documents", "documents");
    }
    ...
    **/
    ...
    public PurchaseOrderEntity create(PurchaseOrderEntity entity) {
        ...
        entity.setExpectedDeliveryDate(getOrDefault(entity.getExpectedDeliveryDate(), LocalDate.now()));
        entity.setOrderStatus(getOrDefault(entity.getOrderStatus(), OrderStatusEnum.FIELD_0));
        entity.setSupplierName(getOrDefault(entity.getSupplierName(), ""));
        entity.setManager(getOrDefault(entity.getManager(), 0L));
        entity.setSupplier(getOrDefault(entity.getSupplier(), 0L));
        entity.setAfter(getOrDefault(entity.getAfter(), AfterstatusEnum.FIELD_0));
        entity.setDelivery_order(getOrDefault(entity.getDelivery_order(), ""));
        entity.setDocuments(getOrDefault(entity.getDocuments(), DocumentsEnum.FIELD_0));
    ...
    **/
    ...
    public long delete( Long id ) { 
        ...
        PurchaseOrderEntity entity = mapper.selectOne( id ); 
    ...
    **/
    ...
    public long batchDelete(List<Long> ids) {
        ...
        AbstractQueryFilter inQueryFilter = new InQueryFilter()
            .left(new ColumnQueryFilter("PurchaseOrder", "purchase_order", "id", "id"))
     ...
     * auto gen get method
     **/
    public PurchaseOrderEntity get( Long id ) { 
        if ( id == null ) { 
            throw new HttpCodeException(400, ErrorCodeEnum.PARAM_PRIMARY_KEY_REQUIRED.code);
        }
    ...
    **/
    ...
    public PurchaseOrderEntity createOrUpdate(PurchaseOrderEntity entity, List<String> updateFields) {
        ...
        if ( entity.getId() == null ) { 
            ...
            PurchaseOrderEntity existEntity = mapper.selectOne(entity.getId()); 
            if (null == existEntity) {
                // insert
                entity.setCreatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
                entity.setUpdatedTime(ZonedDateTime.now(ZoneId.of("UTC")));
