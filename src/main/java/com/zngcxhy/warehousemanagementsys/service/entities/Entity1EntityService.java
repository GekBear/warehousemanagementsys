...
import com.zngcxhy.warehousemanagementsys.repository.entities.Entity1EntityMapper;
...
/**
* auto generate Entity1Entity ServiceImpl
*
* @author sys
*/
@Service
public class Entity1EntityService extends AbstractService {
    ...
    public Entity1EntityService() {
        ...
        entityFieldTitleNameMap.put("name", "name");
        entityFiledColumnNameMap.put("name", "name");
        entityFieldTitleNameMap.put("fileurl", "fileurl");
        entityFiledColumnNameMap.put("fileurl", "fileurl");
    }
