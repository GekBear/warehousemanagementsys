...
import com.zngcxhy.warehousemanagementsys.repository.entities.InventoryEntityMapper;
...
/**
* auto generate InventoryEntity ServiceImpl
*
* @author sys
*/
@Service
public class InventoryEntityService extends AbstractService {
    ...
    public InventoryEntityService() {
        ...
        entityFiledColumnNameMap.put("productId", "product_id");
        ...
        entityFieldNameTitleMap.put("shelfId", "货架ID");
        entityFieldTitleNameMap.put("货架ID", "shelfId");
        entityFiledColumnNameMap.put("shelfId", "shelf_id");
        entityFieldNameTitleMap.put("productnumber", "产品数量");
        entityFieldTitleNameMap.put("产品数量", "productnumber");
        entityFiledColumnNameMap.put("productnumber", "productnumber");
        entityFieldNameTitleMap.put("inwarehouseId", "入库批次");
        entityFieldTitleNameMap.put("入库批次", "inwarehouseId");
        entityFiledColumnNameMap.put("inwarehouseId", "inwarehouse_id");
    }
    ...
    **/
    ...
    public InventoryEntity create(InventoryEntity entity) {
        ...
        entity.setShelfId(getOrDefault(entity.getShelfId(), 0L));
        entity.setProductnumber(getOrDefault(entity.getProductnumber(), 0L));
        entity.setInwarehouseId(getOrDefault(entity.getInwarehouseId(), 0L));
