...
/**
* auto generate Loadpurchase1CustomizeService logic
*
* @author sys
*/
@Service
public class Loadpurchase1CustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private Loadpurchase1CustomizeServiceMapper loadpurchase1CustomizeServiceMapper;

	public Long  loadpurchase1() {
		Long result = 0L;
		result=loadpurchase1CustomizeServiceMapper.getStructure1();
		return result;
	}
