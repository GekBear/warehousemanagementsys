...
/**
* auto generate LoadproductnumCustomizeService logic
*
* @author sys
*/
@Service
public class LoadproductnumCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadproductnumCustomizeServiceMapper loadproductnumCustomizeServiceMapper;

	public Long  loadproductnum(Long param1) {
		Long result = 0L;
		result=CommonFunctionUtil.length(CommonFunctionUtil.createListPage(loadproductnumCustomizeServiceMapper.getAnonymousStructure_D973E5D521E557621AB6C7C329CD488F(param1), loadproductnumCustomizeServiceMapper.countAnonymousStructure_D973E5D521E557621AB6C7C329CD488F(param1).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_D973E5D521E557621AB6C7C329CD488F.class).list);
		return result;
	}
