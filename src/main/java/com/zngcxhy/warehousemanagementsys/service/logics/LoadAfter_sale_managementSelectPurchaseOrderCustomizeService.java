...
/**
* auto generate LoadAfter_sale_managementSelectPurchaseOrderCustomizeService logic
*
* @author sys
*/
@Service
public class LoadAfter_sale_managementSelectPurchaseOrderCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadAfter_sale_managementSelectPurchaseOrderCustomizeServiceMapper loadAfter_sale_managementSelectPurchaseOrderCustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_15236DED8CD807484AC741CD838A113B  loadAfter_sale_managementSelectPurchaseOrder(Long page,Long size) {
