...
/**
* auto generate Logic1orderCustomizeService logic
*
* @author sys
*/
@Service
public class Logic1orderCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private Logic1orderCustomizeServiceMapper logic1orderCustomizeServiceMapper;

	public List<com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_28406730B11920D8D74F4BCB897DBD72>  logic1order(Long id) {
		List<com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_28406730B11920D8D74F4BCB897DBD72> result = new ArrayList <>();
		result=CommonFunctionUtil.createListPage(logic1orderCustomizeServiceMapper.getAnonymousStructure_00C696A2C37E41565D1436EC4B43FEA3(id), logic1orderCustomizeServiceMapper.countAnonymousStructure_00C696A2C37E41565D1436EC4B43FEA3(id).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_00C696A2C37E41565D1436EC4B43FEA3.class).list;
		return result;
	}
