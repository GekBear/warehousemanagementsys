...
/**
* auto generate LoadOrderNumberCustomizeService logic
*
* @author sys
*/
@Service
public class LoadOrderNumberCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadOrderNumberCustomizeServiceMapper loadOrderNumberCustomizeServiceMapper;

	public Long  loadOrderNumber(Long supllierId) {
		Long result = 0L;
		result=loadOrderNumberCustomizeServiceMapper.getStructure1(supllierId);
		return result;
	}
