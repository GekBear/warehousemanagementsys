...
/**
* auto generate LoadInventory_managementSelect3CustomizeService logic
*
* @author sys
*/
@Service
public class LoadInventory_managementSelect3CustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadInventory_managementSelect3CustomizeServiceMapper loadInventory_managementSelect3CustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_D973E5D521E557621AB6C7C329CD488F  loadInventory_managementSelect3(Long page,Long size) {
		...
		result=CommonFunctionUtil.createListPage(loadInventory_managementSelect3CustomizeServiceMapper.getAnonymousStructure_D973E5D521E557621AB6C7C329CD488F(size,page), loadInventory_managementSelect3CustomizeServiceMapper.countAnonymousStructure_D973E5D521E557621AB6C7C329CD488F(size,page).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_D973E5D521E557621AB6C7C329CD488F.class);
		return result;
	}
