...
/**
* auto generate LoadAfter_sale_managementSelect1PurchaseOrderCustomizeService logic
*
* @author sys
*/
@Service
public class LoadAfter_sale_managementSelect1PurchaseOrderCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadAfter_sale_managementSelect1PurchaseOrderCustomizeServiceMapper loadAfter_sale_managementSelect1PurchaseOrderCustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_90BB04F104917B26166C550B4A1B0632  loadAfter_sale_managementSelect1PurchaseOrder(Long page,Long size) {
		...
		result=CommonFunctionUtil.createListPage(loadAfter_sale_managementSelect1PurchaseOrderCustomizeServiceMapper.getAnonymousStructure_90BB04F104917B26166C550B4A1B0632(size,page), loadAfter_sale_managementSelect1PurchaseOrderCustomizeServiceMapper.countAnonymousStructure_90BB04F104917B26166C550B4A1B0632(size,page).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_90BB04F104917B26166C550B4A1B0632.class);
		return result;
	}
