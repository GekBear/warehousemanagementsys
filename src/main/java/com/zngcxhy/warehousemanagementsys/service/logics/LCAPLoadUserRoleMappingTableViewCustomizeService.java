...
public class LCAPLoadUserRoleMappingTableViewCustomizeService {
	...
	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_A43B95DDE943F37E89AA74CCF8732C90  lCAPLoadUserRoleMappingTableView(Long page,Long size,String sort,String order,LCAPUserRoleMapping filter) {
		...
		result=CommonFunctionUtil.createListPage(lCAPLoadUserRoleMappingTableViewCustomizeServiceMapper.getAnonymousStructure_A43B95DDE943F37E89AA74CCF8732C90(filter,size,getTableField("AnonymousStructure_99BA20F3093BB3AC3F3CA0BCA6D65EB8",sort),page,order), lCAPLoadUserRoleMappingTableViewCustomizeServiceMapper.countAnonymousStructure_A43B95DDE943F37E89AA74CCF8732C90(filter,size,getTableField("AnonymousStructure_99BA20F3093BB3AC3F3CA0BCA6D65EB8",sort),page,order).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_A43B95DDE943F37E89AA74CCF8732C90.class);
		return result;
	}
