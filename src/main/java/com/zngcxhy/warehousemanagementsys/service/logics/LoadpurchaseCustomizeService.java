...
/**
* auto generate LoadpurchaseCustomizeService logic
*
* @author sys
*/
@Service
public class LoadpurchaseCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadpurchaseCustomizeServiceMapper loadpurchaseCustomizeServiceMapper;

	public Long  loadpurchase() {
		Long result = 0L;
		result=loadpurchaseCustomizeServiceMapper.getStructure1();
		return result;
	}
