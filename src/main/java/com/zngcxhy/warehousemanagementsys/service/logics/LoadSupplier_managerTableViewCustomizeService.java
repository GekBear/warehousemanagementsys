...
/**
* auto generate LoadSupplier_managerTableViewCustomizeService logic
*
* @author sys
*/
@Service
public class LoadSupplier_managerTableViewCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadSupplier_managerTableViewCustomizeServiceMapper loadSupplier_managerTableViewCustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_15236DED8CD807484AC741CD838A113B  loadSupplier_managerTableView(Long page,Long size,String sort,String order,PurchaseOrderEntity filter,Long supplierID) {
		...
		result=CommonFunctionUtil.createListPage(loadSupplier_managerTableViewCustomizeServiceMapper.getAnonymousStructure_15236DED8CD807484AC741CD838A113B(filter,supplierID,size,getTableField("AnonymousStructure_B0D6BA4B2283DC4DA976DAF31C826073",sort),page,order), loadSupplier_managerTableViewCustomizeServiceMapper.countAnonymousStructure_15236DED8CD807484AC741CD838A113B(filter,supplierID,size,getTableField("AnonymousStructure_B0D6BA4B2283DC4DA976DAF31C826073",sort),page,order).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_15236DED8CD807484AC741CD838A113B.class);
		return result;
	}
