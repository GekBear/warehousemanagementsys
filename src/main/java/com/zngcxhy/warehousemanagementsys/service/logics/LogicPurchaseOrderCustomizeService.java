...
/**
* auto generate LogicPurchaseOrderCustomizeService logic
*
* @author sys
*/
@Service
public class LogicPurchaseOrderCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LogicPurchaseOrderCustomizeServiceMapper logicPurchaseOrderCustomizeServiceMapper;

	public PurchaseOrderEntity  logicPurchaseOrder(Long purchaseOrderId) {
		List<com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_B0D6BA4B2283DC4DA976DAF31C826073> variable1 = new ArrayList <>();
		com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_B0D6BA4B2283DC4DA976DAF31C826073 variable2 = new com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_B0D6BA4B2283DC4DA976DAF31C826073();
		PurchaseOrderEntity result = new PurchaseOrderEntity();
		variable1=CommonFunctionUtil.createListPage(logicPurchaseOrderCustomizeServiceMapper.getAnonymousStructure_15236DED8CD807484AC741CD838A113B(purchaseOrderId), logicPurchaseOrderCustomizeServiceMapper.countAnonymousStructure_15236DED8CD807484AC741CD838A113B(purchaseOrderId).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_15236DED8CD807484AC741CD838A113B.class).list;
		if((CommonFunctionUtil.length(variable1).compareTo(0L) > 0)) {
			variable2=CommonFunctionUtil.get(variable1,0L);
			result=variable2.purchaseOrder;
		} else {
		}
		return result;
	}
