...
/**
* auto generate LoadPurchasin_managementTableView1CustomizeService logic
*
* @author sys
*/
@Service
public class LoadPurchasin_managementTableView1CustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadPurchasin_managementTableView1CustomizeServiceMapper loadPurchasin_managementTableView1CustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_15236DED8CD807484AC741CD838A113B  loadPurchasin_managementTableView1(Long page,Long size,String sort,String order,PurchaseOrderEntity filter) {
		...
		result=CommonFunctionUtil.createListPage(loadPurchasin_managementTableView1CustomizeServiceMapper.getAnonymousStructure_15236DED8CD807484AC741CD838A113B(filter,size,getTableField("AnonymousStructure_B0D6BA4B2283DC4DA976DAF31C826073",sort),page,order), loadPurchasin_managementTableView1CustomizeServiceMapper.countAnonymousStructure_15236DED8CD807484AC741CD838A113B(filter,size,getTableField("AnonymousStructure_B0D6BA4B2283DC4DA976DAF31C826073",sort),page,order).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_15236DED8CD807484AC741CD838A113B.class);
		return result;
	}
