...
public class LCAPIsAlreadBindUserIdListCustomizeService {
	...
	public Boolean  lCAPIsAlreadBindUserIdList(String newUserId,Long inputRoleId) {
		...
		List<com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_E69C6A05AFC359D00B28F67D0E02C8E5> userList = new ArrayList <>();
		...
		for(Long i = 0L; i < CommonFunctionUtil.length(userList); i++ ) {
			com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_E69C6A05AFC359D00B28F67D0E02C8E5  item = userList.get(i.intValue());
