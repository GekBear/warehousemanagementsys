...
/**
* auto generate LoadContract_managementSelectCustomizeService logic
*
* @author sys
*/
@Service
public class LoadContract_managementSelectCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadContract_managementSelectCustomizeServiceMapper loadContract_managementSelectCustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_15236DED8CD807484AC741CD838A113B  loadContract_managementSelect(Long page,Long size) {
		...
		result=CommonFunctionUtil.createListPage(loadContract_managementSelectCustomizeServiceMapper.getAnonymousStructure_15236DED8CD807484AC741CD838A113B(size,page), loadContract_managementSelectCustomizeServiceMapper.countAnonymousStructure_15236DED8CD807484AC741CD838A113B(size,page).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_15236DED8CD807484AC741CD838A113B.class);
		return result;
	}
