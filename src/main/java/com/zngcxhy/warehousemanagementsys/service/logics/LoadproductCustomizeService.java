...
/**
* auto generate LoadproductCustomizeService logic
*
* @author sys
*/
@Service
public class LoadproductCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadproductCustomizeServiceMapper loadproductCustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_E03BAD4CA7266D3FC9D0ED04DB665CDA  loadproduct(Long supplierId) {
		com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_E03BAD4CA7266D3FC9D0ED04DB665CDA result = new com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_E03BAD4CA7266D3FC9D0ED04DB665CDA();
		result=CommonFunctionUtil.createListPage(loadproductCustomizeServiceMapper.getAnonymousStructure_E03BAD4CA7266D3FC9D0ED04DB665CDA(supplierId), loadproductCustomizeServiceMapper.countAnonymousStructure_E03BAD4CA7266D3FC9D0ED04DB665CDA(supplierId).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_E03BAD4CA7266D3FC9D0ED04DB665CDA.class);
		return result;
	}
