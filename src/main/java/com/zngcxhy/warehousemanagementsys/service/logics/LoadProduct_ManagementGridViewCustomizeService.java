...
/**
* auto generate LoadProduct_ManagementGridViewCustomizeService logic
*
* @author sys
*/
@Service
public class LoadProduct_ManagementGridViewCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadProduct_ManagementGridViewCustomizeServiceMapper loadProduct_ManagementGridViewCustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_D973E5D521E557621AB6C7C329CD488F  loadProduct_ManagementGridView(Long page,Long size,String sort,String order,ProductEntity filter,Long supplierID) {
		...
		result=CommonFunctionUtil.createListPage(loadProduct_ManagementGridViewCustomizeServiceMapper.getAnonymousStructure_D973E5D521E557621AB6C7C329CD488F(filter,supplierID,size,getTableField("AnonymousStructure_9ECE35F6B2A89475F87BB2D49DE0DDB8",sort),page,order), loadProduct_ManagementGridViewCustomizeServiceMapper.countAnonymousStructure_D973E5D521E557621AB6C7C329CD488F(filter,supplierID,size,getTableField("AnonymousStructure_9ECE35F6B2A89475F87BB2D49DE0DDB8",sort),page,order).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_D973E5D521E557621AB6C7C329CD488F.class);
		return result;
	}
