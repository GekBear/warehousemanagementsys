...
/**
* auto generate LoadingPurchaseOrderDatilCustomizeService logic
*
* @author sys
*/
@Service
public class LoadingPurchaseOrderDatilCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadingPurchaseOrderDatilCustomizeServiceMapper loadingPurchaseOrderDatilCustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_00C696A2C37E41565D1436EC4B43FEA3  loadingPurchaseOrderDatil(Long purchaseOrderId) {
		...
		result=CommonFunctionUtil.createListPage(loadingPurchaseOrderDatilCustomizeServiceMapper.getAnonymousStructure_00C696A2C37E41565D1436EC4B43FEA3(purchaseOrderId), loadingPurchaseOrderDatilCustomizeServiceMapper.countAnonymousStructure_00C696A2C37E41565D1436EC4B43FEA3(purchaseOrderId).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_00C696A2C37E41565D1436EC4B43FEA3.class);
		return result;
	}
