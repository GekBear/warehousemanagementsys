...
/**
* auto generate LoadinvaCustomizeService logic
*
* @author sys
*/
@Service
public class LoadinvaCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadinvaCustomizeServiceMapper loadinvaCustomizeServiceMapper;

	public List<com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_6137BC56C51B4B79E581ABCB94F7B2CE>  loadinva() {
		List<com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_6137BC56C51B4B79E581ABCB94F7B2CE> result = new ArrayList <>();
		result=CommonFunctionUtil.createListPage(loadinvaCustomizeServiceMapper.getAnonymousStructure_FA04CAEB20E1A6EBA60E0BECDFDA7215(), loadinvaCustomizeServiceMapper.countAnonymousStructure_FA04CAEB20E1A6EBA60E0BECDFDA7215().intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_FA04CAEB20E1A6EBA60E0BECDFDA7215.class).list;
		return result;
	}
