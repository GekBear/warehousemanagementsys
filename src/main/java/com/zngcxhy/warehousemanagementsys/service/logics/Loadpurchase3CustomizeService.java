...
/**
* auto generate Loadpurchase3CustomizeService logic
*
* @author sys
*/
@Service
public class Loadpurchase3CustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private Loadpurchase3CustomizeServiceMapper loadpurchase3CustomizeServiceMapper;

	public Long  loadpurchase3() {
		Long result = 0L;
		result=loadpurchase3CustomizeServiceMapper.getStructure1();
		return result;
	}
