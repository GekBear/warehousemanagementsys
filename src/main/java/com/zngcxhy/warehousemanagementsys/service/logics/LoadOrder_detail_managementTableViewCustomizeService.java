...
/**
* auto generate LoadOrder_detail_managementTableViewCustomizeService logic
*
* @author sys
*/
@Service
public class LoadOrder_detail_managementTableViewCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadOrder_detail_managementTableViewCustomizeServiceMapper loadOrder_detail_managementTableViewCustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_00C696A2C37E41565D1436EC4B43FEA3  loadOrder_detail_managementTableView(Long page,Long size,String sort,String order,PurchaseOrderDetaiEntity filter) {
		...
		result=CommonFunctionUtil.createListPage(loadOrder_detail_managementTableViewCustomizeServiceMapper.getAnonymousStructure_00C696A2C37E41565D1436EC4B43FEA3(filter,size,getTableField("AnonymousStructure_28406730B11920D8D74F4BCB897DBD72",sort),page,order), loadOrder_detail_managementTableViewCustomizeServiceMapper.countAnonymousStructure_00C696A2C37E41565D1436EC4B43FEA3(filter,size,getTableField("AnonymousStructure_28406730B11920D8D74F4BCB897DBD72",sort),page,order).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_00C696A2C37E41565D1436EC4B43FEA3.class);
		return result;
	}
