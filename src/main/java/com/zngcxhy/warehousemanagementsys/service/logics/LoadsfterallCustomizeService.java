...
/**
* auto generate LoadsfterallCustomizeService logic
*
* @author sys
*/
@Service
public class LoadsfterallCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadsfterallCustomizeServiceMapper loadsfterallCustomizeServiceMapper;

	public Long  loadsfterall() {
		Long result = 0L;
		result=loadsfterallCustomizeServiceMapper.getStructure1();
		return result;
	}
