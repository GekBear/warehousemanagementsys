...
/**
* auto generate Loadpurchase2CustomizeService logic
*
* @author sys
*/
@Service
public class Loadpurchase2CustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private Loadpurchase2CustomizeServiceMapper loadpurchase2CustomizeServiceMapper;

	public Long  loadpurchase2() {
		Long result = 0L;
		result=loadpurchase2CustomizeServiceMapper.getStructure1();
		return result;
	}
