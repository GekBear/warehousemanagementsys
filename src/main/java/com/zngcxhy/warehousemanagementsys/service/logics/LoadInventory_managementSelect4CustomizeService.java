...
/**
* auto generate LoadInventory_managementSelect4CustomizeService logic
*
* @author sys
*/
@Service
public class LoadInventory_managementSelect4CustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadInventory_managementSelect4CustomizeServiceMapper loadInventory_managementSelect4CustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_90BB04F104917B26166C550B4A1B0632  loadInventory_managementSelect4(Long page,Long size) {
