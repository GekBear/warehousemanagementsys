...
/**
* auto generate LogicproductCustomizeService logic
*
* @author sys
*/
@Service
public class LogicproductCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LogicproductCustomizeServiceMapper logicproductCustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_0A8196CA87209D0F0E1829C6F6519FAA  logicproduct(Long supplierID) {
		...
		result=CommonFunctionUtil.createListPage(logicproductCustomizeServiceMapper.getAnonymousStructure_0A8196CA87209D0F0E1829C6F6519FAA(supplierID), logicproductCustomizeServiceMapper.countAnonymousStructure_0A8196CA87209D0F0E1829C6F6519FAA(supplierID).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_0A8196CA87209D0F0E1829C6F6519FAA.class);
		return result;
	}
