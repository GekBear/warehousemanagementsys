...
/**
* auto generate LoadAfter_sale_managementTableView1CustomizeService logic
*
* @author sys
*/
@Service
public class LoadAfter_sale_managementTableView1CustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadAfter_sale_managementTableView1CustomizeServiceMapper loadAfter_sale_managementTableView1CustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_3155819A39245BFBE1F9D48E70DC8203  loadAfter_sale_managementTableView1(Long page,Long size,String sort,String order,Long supplierID) {
		...
		result=CommonFunctionUtil.createListPage(loadAfter_sale_managementTableView1CustomizeServiceMapper.getAnonymousStructure_3155819A39245BFBE1F9D48E70DC8203(supplierID,size,getTableField("AnonymousStructure_549508BDC1898EC803BEBB94E48237F8",sort),page,order), loadAfter_sale_managementTableView1CustomizeServiceMapper.countAnonymousStructure_3155819A39245BFBE1F9D48E70DC8203(supplierID,size,getTableField("AnonymousStructure_549508BDC1898EC803BEBB94E48237F8",sort),page,order).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_3155819A39245BFBE1F9D48E70DC8203.class);
		return result;
	}
