...
/**
* auto generate LoadproductNumberCustomizeService logic
*
* @author sys
*/
@Service
public class LoadproductNumberCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadproductNumberCustomizeServiceMapper loadproductNumberCustomizeServiceMapper;

	public Long  loadproductNumber(Long supllierId) {
		Long result = 0L;
		result=loadproductNumberCustomizeServiceMapper.getStructure1(supllierId);
		return result;
	}
