...
/**
* auto generate LoadPurchase_of_productsGridViewCustomizeService logic
*
* @author sys
*/
@Service
public class LoadPurchase_of_productsGridViewCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadPurchase_of_productsGridViewCustomizeServiceMapper loadPurchase_of_productsGridViewCustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_D973E5D521E557621AB6C7C329CD488F  loadPurchase_of_productsGridView(Long page,Long size,String sort,String order,Long supplierID,List<Long> idList) {
		...
		result=CommonFunctionUtil.createListPage(loadPurchase_of_productsGridViewCustomizeServiceMapper.getAnonymousStructure_D973E5D521E557621AB6C7C329CD488F(supplierID,size,idList,getTableField("AnonymousStructure_9ECE35F6B2A89475F87BB2D49DE0DDB8",sort),page,order), loadPurchase_of_productsGridViewCustomizeServiceMapper.countAnonymousStructure_D973E5D521E557621AB6C7C329CD488F(supplierID,size,idList,getTableField("AnonymousStructure_9ECE35F6B2A89475F87BB2D49DE0DDB8",sort),page,order).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_D973E5D521E557621AB6C7C329CD488F.class);
		return result;
	}
