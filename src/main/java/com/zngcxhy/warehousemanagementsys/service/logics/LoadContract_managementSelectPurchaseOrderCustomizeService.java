...
/**
* auto generate LoadContract_managementSelectPurchaseOrderCustomizeService logic
*
* @author sys
*/
@Service
public class LoadContract_managementSelectPurchaseOrderCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadContract_managementSelectPurchaseOrderCustomizeServiceMapper loadContract_managementSelectPurchaseOrderCustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_15236DED8CD807484AC741CD838A113B  loadContract_managementSelectPurchaseOrder(Long page,Long size) {
		...
		result=CommonFunctionUtil.createListPage(loadContract_managementSelectPurchaseOrderCustomizeServiceMapper.getAnonymousStructure_15236DED8CD807484AC741CD838A113B(size,page), loadContract_managementSelectPurchaseOrderCustomizeServiceMapper.countAnonymousStructure_15236DED8CD807484AC741CD838A113B(size,page).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_15236DED8CD807484AC741CD838A113B.class);
		return result;
	}
