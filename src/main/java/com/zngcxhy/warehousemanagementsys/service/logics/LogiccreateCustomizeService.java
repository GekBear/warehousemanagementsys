...
/**
* auto generate LogiccreateCustomizeService logic
*
* @author sys
*/
@Service
public class LogiccreateCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LogiccreateCustomizeServiceMapper logiccreateCustomizeServiceMapper;

	public String  logiccreate(String displayName) {
		...
		String result = "";
		variable1=CommonFunctionUtil.createListPage(logiccreateCustomizeServiceMapper.getAnonymousStructure_90BB04F104917B26166C550B4A1B0632(displayName), logiccreateCustomizeServiceMapper.countAnonymousStructure_90BB04F104917B26166C550B4A1B0632(displayName).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_90BB04F104917B26166C550B4A1B0632.class).list;
		if((CommonFunctionUtil.length(variable1).compareTo(0L) > 0)) {
			variable2=CommonFunctionUtil.get(variable1,0L);
			result=variable2.lCAPUser.phone;
		} else {
		}
		return result;
	}
