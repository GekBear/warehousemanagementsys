...
/**
* auto generate Loadafter1CustomizeService logic
*
* @author sys
*/
@Service
public class Loadafter1CustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private Loadafter1CustomizeServiceMapper loadafter1CustomizeServiceMapper;

	public Long  loadafter1() {
		Long result = 0L;
		result=loadafter1CustomizeServiceMapper.getStructure1();
		return result;
	}
