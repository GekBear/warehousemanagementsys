...
/**
* auto generate LoadSupplierCustomizeService logic
*
* @author sys
*/
@Service
public class LoadSupplierCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadSupplierCustomizeServiceMapper loadSupplierCustomizeServiceMapper;

	public List<com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_47C167E7217746A55100F50A57F637C0>  loadSupplier(Long roleId) {
		List<com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_47C167E7217746A55100F50A57F637C0> result = new ArrayList <>();
		result=CommonFunctionUtil.createListPage(loadSupplierCustomizeServiceMapper.getAnonymousStructure_90BB04F104917B26166C550B4A1B0632(roleId), loadSupplierCustomizeServiceMapper.countAnonymousStructure_90BB04F104917B26166C550B4A1B0632(roleId).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_90BB04F104917B26166C550B4A1B0632.class).list;
		return result;
	}
