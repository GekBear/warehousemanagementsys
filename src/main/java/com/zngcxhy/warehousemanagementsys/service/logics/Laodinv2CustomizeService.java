...
/**
* auto generate Laodinv2CustomizeService logic
*
* @author sys
*/
@Service
public class Laodinv2CustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private Laodinv2CustomizeServiceMapper laodinv2CustomizeServiceMapper;

	public List<com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_B0D6BA4B2283DC4DA976DAF31C826073>  laodinv2() {
		...
		result=CommonFunctionUtil.createListPage(laodinv2CustomizeServiceMapper.getAnonymousStructure_15236DED8CD807484AC741CD838A113B(), laodinv2CustomizeServiceMapper.countAnonymousStructure_15236DED8CD807484AC741CD838A113B().intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_15236DED8CD807484AC741CD838A113B.class).list;
		return result;
	}
