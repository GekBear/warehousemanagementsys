...
/**
* auto generate LoadInventory_managementSelect5CustomizeService logic
*
* @author sys
*/
@Service
public class LoadInventory_managementSelect5CustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadInventory_managementSelect5CustomizeServiceMapper loadInventory_managementSelect5CustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_7F0FC9CD7C0E19CDEBEF556E681E6B3C  loadInventory_managementSelect5(Long page,Long size) {
		...
		result=CommonFunctionUtil.createListPage(loadInventory_managementSelect5CustomizeServiceMapper.getAnonymousStructure_7F0FC9CD7C0E19CDEBEF556E681E6B3C(size,page), loadInventory_managementSelect5CustomizeServiceMapper.countAnonymousStructure_7F0FC9CD7C0E19CDEBEF556E681E6B3C(size,page).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_7F0FC9CD7C0E19CDEBEF556E681E6B3C.class);
		return result;
	}
