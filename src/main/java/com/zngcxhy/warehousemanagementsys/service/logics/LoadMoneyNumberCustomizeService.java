...
/**
* auto generate LoadMoneyNumberCustomizeService logic
*
* @author sys
*/
@Service
public class LoadMoneyNumberCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadMoneyNumberCustomizeServiceMapper loadMoneyNumberCustomizeServiceMapper;

	public BigDecimal  loadMoneyNumber(Long supllierId) {
		BigDecimal result = BigDecimal.ZERO;
		result=loadMoneyNumberCustomizeServiceMapper.getStructure1(supllierId);
		return result;
	}
