...
/**
* auto generate LoadInvoice_managementSelect_1CustomizeService logic
*
* @author sys
*/
@Service
public class LoadInvoice_managementSelect_1CustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadInvoice_managementSelect_1CustomizeServiceMapper loadInvoice_managementSelect_1CustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_15236DED8CD807484AC741CD838A113B  loadInvoice_managementSelect_1(Long page,Long size) {
		...
		result=CommonFunctionUtil.createListPage(loadInvoice_managementSelect_1CustomizeServiceMapper.getAnonymousStructure_15236DED8CD807484AC741CD838A113B(size,page), loadInvoice_managementSelect_1CustomizeServiceMapper.countAnonymousStructure_15236DED8CD807484AC741CD838A113B(size,page).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_15236DED8CD807484AC741CD838A113B.class);
		return result;
	}
