...
/**
* auto generate LogicwarehouseCustomizeService logic
*
* @author sys
*/
@Service
public class LogicwarehouseCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LogicwarehouseCustomizeServiceMapper logicwarehouseCustomizeServiceMapper;

	public List<com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_F349DEC1E5A50FAAD59CBCBBFB541B93>  logicwarehouse() {
		List<com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_F349DEC1E5A50FAAD59CBCBBFB541B93> result = new ArrayList <>();
		result=CommonFunctionUtil.createListPage(logicwarehouseCustomizeServiceMapper.getAnonymousStructure_F38430154A940234D722FC75BC91969C(), logicwarehouseCustomizeServiceMapper.countAnonymousStructure_F38430154A940234D722FC75BC91969C().intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_F38430154A940234D722FC75BC91969C.class).list;
		return result;
	}
