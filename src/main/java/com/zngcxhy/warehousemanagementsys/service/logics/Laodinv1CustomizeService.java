...
/**
* auto generate Laodinv1CustomizeService logic
*
* @author sys
*/
@Service
public class Laodinv1CustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private Laodinv1CustomizeServiceMapper laodinv1CustomizeServiceMapper;

	public List<com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_B0D6BA4B2283DC4DA976DAF31C826073>  laodinv1() {
