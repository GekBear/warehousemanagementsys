...
/**
* auto generate InviteCustomizeService logic
*
* @author sys
*/
@Service
public class InviteCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private InviteCustomizeServiceMapper inviteCustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_15236DED8CD807484AC741CD838A113B  invite(Long supplierid) {
