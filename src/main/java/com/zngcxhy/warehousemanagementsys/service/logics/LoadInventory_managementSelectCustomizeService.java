...
/**
* auto generate LoadInventory_managementSelectCustomizeService logic
*
* @author sys
*/
@Service
public class LoadInventory_managementSelectCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadInventory_managementSelectCustomizeServiceMapper loadInventory_managementSelectCustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_F38430154A940234D722FC75BC91969C  loadInventory_managementSelect(Long page,Long size) {
		...
		result=CommonFunctionUtil.createListPage(loadInventory_managementSelectCustomizeServiceMapper.getAnonymousStructure_F38430154A940234D722FC75BC91969C(size,page), loadInventory_managementSelectCustomizeServiceMapper.countAnonymousStructure_F38430154A940234D722FC75BC91969C(size,page).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_F38430154A940234D722FC75BC91969C.class);
		return result;
	}
