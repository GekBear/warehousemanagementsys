...
/**
* auto generate LogicproductAmoutCustomizeService logic
*
* @author sys
*/
@Service
public class LogicproductAmoutCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LogicproductAmoutCustomizeServiceMapper logicproductAmoutCustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_0A8196CA87209D0F0E1829C6F6519FAA  logicproductAmout(Long supplierID) {
		com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_0A8196CA87209D0F0E1829C6F6519FAA result = new com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_0A8196CA87209D0F0E1829C6F6519FAA();
		result=CommonFunctionUtil.createListPage(logicproductAmoutCustomizeServiceMapper.getAnonymousStructure_0A8196CA87209D0F0E1829C6F6519FAA(supplierID), logicproductAmoutCustomizeServiceMapper.countAnonymousStructure_0A8196CA87209D0F0E1829C6F6519FAA(supplierID).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_0A8196CA87209D0F0E1829C6F6519FAA.class);
		return result;
	}
