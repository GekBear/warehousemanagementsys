...
public class LCAPLoadResourceTableViewCustomizeService {
	...
	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_D8CB63E646D19A8E127BF2A118560F92  lCAPLoadResourceTableView(Long page,Long size,String sort,String order) {
		com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_D8CB63E646D19A8E127BF2A118560F92 result = new com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_D8CB63E646D19A8E127BF2A118560F92();
		result=CommonFunctionUtil.createListPage(lCAPLoadResourceTableViewCustomizeServiceMapper.getAnonymousStructure_D8CB63E646D19A8E127BF2A118560F92(size,getTableField("AnonymousStructure_EA050579F163467B7D2FD3E8C15362AF",sort),page,order), lCAPLoadResourceTableViewCustomizeServiceMapper.countAnonymousStructure_D8CB63E646D19A8E127BF2A118560F92(size,getTableField("AnonymousStructure_EA050579F163467B7D2FD3E8C15362AF",sort),page,order).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_D8CB63E646D19A8E127BF2A118560F92.class);
		return result;
	}
    ...
    static {
        ...
        tableColumnMap = structureTableColumnMap.get("AnonymousStructure_EA050579F163467B7D2FD3E8C15362AF");
            tableColumnMap.put("lCAPResource.updatedTime","`lcap_resource_6568a7`.`updated_time`");
            tableColumnMap.put("lCAPResource.updatedBy","`lcap_resource_6568a7`.`updated_by`");
            tableColumnMap.put("lCAPResource.createdBy","`lcap_resource_6568a7`.`created_by`");
            tableColumnMap.put("lCAPResource.id","`lcap_resource_6568a7`.`id`");
            tableColumnMap.put("lCAPResource.type","`lcap_resource_6568a7`.`type`");
            tableColumnMap.put("lCAPResource.createdTime","`lcap_resource_6568a7`.`created_time`");
            tableColumnMap.put("lCAPResource.uuid","`lcap_resource_6568a7`.`uuid`");
            tableColumnMap.put("lCAPResource.description","`lcap_resource_6568a7`.`description`");
            tableColumnMap.put("lCAPResource.name","`lcap_resource_6568a7`.`name`");
            tableColumnMap.put("lCAPResource.clientType","`lcap_resource_6568a7`.`client_type`");
