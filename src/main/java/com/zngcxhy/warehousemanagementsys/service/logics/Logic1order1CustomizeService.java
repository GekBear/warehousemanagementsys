...
/**
* auto generate Logic1order1CustomizeService logic
*
* @author sys
*/
@Service
public class Logic1order1CustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private Logic1order1CustomizeServiceMapper logic1order1CustomizeServiceMapper;

	public PurchaseOrderEntity  logic1order1(Long id) {
		...
		variable1=CommonFunctionUtil.createListPage(logic1order1CustomizeServiceMapper.getAnonymousStructure_15236DED8CD807484AC741CD838A113B(id), logic1order1CustomizeServiceMapper.countAnonymousStructure_15236DED8CD807484AC741CD838A113B(id).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_15236DED8CD807484AC741CD838A113B.class).list;
