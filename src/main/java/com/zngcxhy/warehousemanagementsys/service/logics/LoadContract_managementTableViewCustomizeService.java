...
/**
* auto generate LoadContract_managementTableViewCustomizeService logic
*
* @author sys
*/
@Service
public class LoadContract_managementTableViewCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadContract_managementTableViewCustomizeServiceMapper loadContract_managementTableViewCustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_3F17D6E4D1852D7625F270B1D360C0D8  loadContract_managementTableView(Long page,Long size,String sort,String order,PurchaseContractEntity filter) {
		com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_3F17D6E4D1852D7625F270B1D360C0D8 result = new com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_3F17D6E4D1852D7625F270B1D360C0D8();
		result=CommonFunctionUtil.createListPage(loadContract_managementTableViewCustomizeServiceMapper.getAnonymousStructure_3F17D6E4D1852D7625F270B1D360C0D8(filter,size,getTableField("AnonymousStructure_389101111E722268CBFFC734E5A696C9",sort),page,order), loadContract_managementTableViewCustomizeServiceMapper.countAnonymousStructure_3F17D6E4D1852D7625F270B1D360C0D8(filter,size,getTableField("AnonymousStructure_389101111E722268CBFFC734E5A696C9",sort),page,order).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_3F17D6E4D1852D7625F270B1D360C0D8.class);
		return result;
	}
    ...
    static {
        ...
        if (structureTableColumnMap.get("AnonymousStructure_389101111E722268CBFFC734E5A696C9") == null) {
        structureTableColumnMap.put("AnonymousStructure_389101111E722268CBFFC734E5A696C9",new HashMap<String, String>());
        }
        tableColumnMap = structureTableColumnMap.get("AnonymousStructure_389101111E722268CBFFC734E5A696C9");
            tableColumnMap.put("purchaseContract.contractName","`purchase_contract`.`contract_name`");
            ...
            tableColumnMap.put("purchaseContract.id","`purchase_contract`.`id`");
            tableColumnMap.put("purchaseContract.updatedTime","`purchase_contract`.`updated_time`");
            tableColumnMap.put("purchaseOrder.supplier","`purchase_order`.`supplier`");
            tableColumnMap.put("purchaseContract.contractFile","`purchase_contract`.`contract_file`");
            tableColumnMap.put("purchaseContract.contractStatus","`purchase_contract`.`contract_status`");
            tableColumnMap.put("purchaseOrder.id","`purchase_order`.`id`");
            tableColumnMap.put("purchaseContract.updatedBy","`purchase_contract`.`updated_by`");
            ...
            tableColumnMap.put("purchaseContract.createdBy","`purchase_contract`.`created_by`");
            ...
            tableColumnMap.put("purchaseContract.orderID","`purchase_contract`.`order_i_d`");
            tableColumnMap.put("purchaseContract.contractAmount","`purchase_contract`.`contract_amount`");
            tableColumnMap.put("purchaseContract.createdTime","`purchase_contract`.`created_time`");
        if (structurePropFieldMap.get("AnonymousStructure_389101111E722268CBFFC734E5A696C9") == null) {
            structurePropFieldMap.put("AnonymousStructure_389101111E722268CBFFC734E5A696C9",new HashMap<String, List<String>>());
        }
         propColumnMap = structurePropFieldMap.get("AnonymousStructure_389101111E722268CBFFC734E5A696C9");
        ...
        if (propColumnMap.get("updatedTime") == null){
            ...
            propColumnMap.get("updatedTime").add("purchaseContract.updatedTime");
        ...
        if (propColumnMap.get("contractStatus") == null){
            propColumnMap.put("contractStatus", new ArrayList<>());
            }
            propColumnMap.get("contractStatus").add("purchaseContract.contractStatus");
        if (propColumnMap.get("updatedBy") == null){
            propColumnMap.put("updatedBy", new ArrayList<>());
            }
            propColumnMap.get("updatedBy").add("purchaseContract.updatedBy");
        ...
        if (propColumnMap.get("orderID") == null){
            ...
            propColumnMap.get("orderID").add("purchaseContract.orderID");
        ...
        if (propColumnMap.get("contractFile") == null){
            propColumnMap.put("contractFile", new ArrayList<>());
            }
            propColumnMap.get("contractFile").add("purchaseContract.contractFile");
        ...
        if (propColumnMap.get("createdBy") == null){
            ...
            propColumnMap.get("createdBy").add("purchaseContract.createdBy");
        ...
        if (propColumnMap.get("contractAmount") == null){
            propColumnMap.put("contractAmount", new ArrayList<>());
            }
            propColumnMap.get("contractAmount").add("purchaseContract.contractAmount");
        if (propColumnMap.get("createdTime") == null){
            propColumnMap.put("createdTime", new ArrayList<>());
            }
            propColumnMap.get("createdTime").add("purchaseContract.createdTime");
            propColumnMap.get("createdTime").add("purchaseOrder.createdTime");
        if (propColumnMap.get("contractName") == null){
            propColumnMap.put("contractName", new ArrayList<>());
            }
            propColumnMap.get("contractName").add("purchaseContract.contractName");
        ...
        if (propColumnMap.get("id") == null){
            ...
            propColumnMap.get("id").add("purchaseContract.id");
