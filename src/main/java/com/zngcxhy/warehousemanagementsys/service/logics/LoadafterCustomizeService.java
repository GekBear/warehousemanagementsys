...
/**
* auto generate LoadafterCustomizeService logic
*
* @author sys
*/
@Service
public class LoadafterCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadafterCustomizeServiceMapper loadafterCustomizeServiceMapper;

	public Long  loadafter() {
		Long result = 0L;
		result=loadafterCustomizeServiceMapper.getStructure1();
		return result;
	}
