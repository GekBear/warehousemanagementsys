...
/**
* auto generate LoadPurchasin_managementTableViewCustomizeService logic
*
* @author sys
*/
@Service
public class LoadPurchasin_managementTableViewCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadPurchasin_managementTableViewCustomizeServiceMapper loadPurchasin_managementTableViewCustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_D973E5D521E557621AB6C7C329CD488F  loadPurchasin_managementTableView(Long page,Long size,String sort,String order,ProductEntity filter) {
		...
		result=CommonFunctionUtil.createListPage(loadPurchasin_managementTableViewCustomizeServiceMapper.getAnonymousStructure_D973E5D521E557621AB6C7C329CD488F(filter,size,getTableField("AnonymousStructure_9ECE35F6B2A89475F87BB2D49DE0DDB8",sort),page,order), loadPurchasin_managementTableViewCustomizeServiceMapper.countAnonymousStructure_D973E5D521E557621AB6C7C329CD488F(filter,size,getTableField("AnonymousStructure_9ECE35F6B2A89475F87BB2D49DE0DDB8",sort),page,order).intValue(), com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_D973E5D521E557621AB6C7C329CD488F.class);
		return result;
	}
