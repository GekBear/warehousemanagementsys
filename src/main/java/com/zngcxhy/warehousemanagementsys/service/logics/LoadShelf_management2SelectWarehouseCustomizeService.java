...
/**
* auto generate LoadShelf_management2SelectWarehouseCustomizeService logic
*
* @author sys
*/
@Service
public class LoadShelf_management2SelectWarehouseCustomizeService {
    private static final Logger LCAP_LOGGER = LoggerFactory.getLogger(Constants.LCAP_CUSTOMIZE_LOGGER);
	@Autowired private LoadShelf_management2SelectWarehouseCustomizeServiceMapper loadShelf_management2SelectWarehouseCustomizeServiceMapper;

	public com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_F38430154A940234D722FC75BC91969C  loadShelf_management2SelectWarehouse(Long page,Long size) {
