...
public class Userlist1Structure {
    ...
    public String name;
    public String alias;
    public com.zngcxhy.warehousemanagementsys.domain.structure.extensions.qiweionlineconnector.ExtattrStructure extattr;
    public String qr_code;
    public String position;
    public List<Long> department = new ArrayList <>();
    public String open_userid;
    public String biz_mail;
    public com.zngcxhy.warehousemanagementsys.domain.structure.extensions.qiweionlineconnector.External_profileStructure external_profile;
    public String email;
    ...
    public com.zngcxhy.warehousemanagementsys.domain.structure.extensions.qiweionlineconnector.ExtattrStructure getExtattr() {
        return extattr;
    }

    public void setExtattr(com.zngcxhy.warehousemanagementsys.domain.structure.extensions.qiweionlineconnector.ExtattrStructure extattr) {
    ...
    public com.zngcxhy.warehousemanagementsys.domain.structure.extensions.qiweionlineconnector.External_profileStructure getExternal_profile() {
        return external_profile;
    }

    public void setExternal_profile(com.zngcxhy.warehousemanagementsys.domain.structure.extensions.qiweionlineconnector.External_profileStructure external_profile) {
