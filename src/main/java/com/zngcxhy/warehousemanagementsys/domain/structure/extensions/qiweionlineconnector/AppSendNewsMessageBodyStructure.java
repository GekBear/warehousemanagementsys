...
public class AppSendNewsMessageBodyStructure {
    ...
    public Long agentid;
    public com.zngcxhy.warehousemanagementsys.domain.structure.extensions.qiweionlineconnector.NewsStructure news;
    ...
    public com.zngcxhy.warehousemanagementsys.domain.structure.extensions.qiweionlineconnector.NewsStructure getNews() {
        return news;
    }

    public void setNews(com.zngcxhy.warehousemanagementsys.domain.structure.extensions.qiweionlineconnector.NewsStructure news) {
        this.news = news;
    }
