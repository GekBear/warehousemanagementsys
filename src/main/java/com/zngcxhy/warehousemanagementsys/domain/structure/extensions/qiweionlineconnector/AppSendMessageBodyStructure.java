...
public class AppSendMessageBodyStructure {
    ...
    public Long agentid;
    public com.zngcxhy.warehousemanagementsys.domain.structure.extensions.qiweionlineconnector.Text4Structure text;
    public Long safe;
    ...
    public com.zngcxhy.warehousemanagementsys.domain.structure.extensions.qiweionlineconnector.Text4Structure getText() {
        return text;
    }

    public void setText(com.zngcxhy.warehousemanagementsys.domain.structure.extensions.qiweionlineconnector.Text4Structure text) {
        this.text = text;
    }
