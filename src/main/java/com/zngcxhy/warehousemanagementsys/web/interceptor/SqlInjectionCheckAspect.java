...
import com.zngcxhy.warehousemanagementsys.util.SqlKeywordsUtils;
import com.zngcxhy.warehousemanagementsys.web.interceptor.annotation.SqlInjectionCheck;
...
public class SqlInjectionCheckAspect {
    ...
    @Pointcut(value = "@annotation(com.zngcxhy.warehousemanagementsys.web.interceptor.annotation.SqlInjectionCheck)")
