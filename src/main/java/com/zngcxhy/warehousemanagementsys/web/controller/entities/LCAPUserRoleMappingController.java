...
public class LCAPUserRoleMappingController {
    ...
    **/
    @Validation(value = {
        @ValidationRuleGroup(
                value = "04aa301b15ec4ed9bd9f05fe539456f8",
                rules = {
                }
        ),
        @ValidationRuleGroup(
                value = "4ff4bbb303244b18b800eff5cd794405",
                rules = {
                }
        ),
        @ValidationRuleGroup(
                value = "cef91096aad8483495db3da246e62c4a",
                rules = {
                }
        ),
    })
    ...
    **/
    @Validation(value = {
        @ValidationRuleGroup(
                value = "fe5252b664ee4575ade12c4da2ba5ec6",
                rules = {
                }
        ),
    })
    ...
    **/
    @Validation(value = {
        @ValidationRuleGroup(
                value = "f639b13331354c5b82c034355e590564",
                rules = {
                }
        ),
    })
