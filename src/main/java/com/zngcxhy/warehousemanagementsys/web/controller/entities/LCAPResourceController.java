...
import com.zngcxhy.warehousemanagementsys.service.entities.LCAPResourceService;
...
public class LCAPResourceController {
    ...
    **/
    @Validation(value = {
        @ValidationRuleGroup(
                value = "a54c6a85f7a24174b5b867b418006936",
                rules = {
                }
        ),
    })
    ...
    **/
    @Validation(value = {
        @ValidationRuleGroup(
                value = "bd318d032f94439e8837471af00670c4",
                rules = {
                }
        ),
    })
