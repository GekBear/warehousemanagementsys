...
/**
* auto generate LoadMoneyNumberCustomizeService Mapper
*
* @author sys
*/
public interface LoadMoneyNumberCustomizeServiceMapper {

BigDecimal getStructure1(@Param("supllierId") Long supllierId);
