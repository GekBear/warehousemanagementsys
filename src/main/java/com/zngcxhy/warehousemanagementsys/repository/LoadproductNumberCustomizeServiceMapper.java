...
/**
* auto generate LoadproductNumberCustomizeService Mapper
*
* @author sys
*/
public interface LoadproductNumberCustomizeServiceMapper {

Long getStructure1(@Param("supllierId") Long supllierId);
