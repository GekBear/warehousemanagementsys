...
/**
* auto generate LoadProduct_ManagementGridViewCustomizeService Mapper
*
* @author sys
*/
public interface LoadProduct_ManagementGridViewCustomizeServiceMapper {

List<com.zngcxhy.warehousemanagementsys.domain.structure.anonymous.AnonymousStructure_9ECE35F6B2A89475F87BB2D49DE0DDB8> getAnonymousStructure_D973E5D521E557621AB6C7C329CD488F(@Param("filter") ProductEntity filter,@Param("supplierID") Long supplierID,@Param("size") Long size,@Param("sort") String sort,@Param("page") Long page,@Param("order") String order);
Long countAnonymousStructure_D973E5D521E557621AB6C7C329CD488F(@Param("filter") ProductEntity filter,@Param("supplierID") Long supplierID,@Param("size") Long size,@Param("sort") String sort,@Param("page") Long page,@Param("order") String order);
